...
import org.nlogo.nvm.{ Activation, CompilerInterface, FileManager, Instruction, Command, Context, Job, MutableLong, ProcedureInterface, Tracer }
...
object AbstractWorkspaceTraits {
  ...
  trait Procedures { this: AbstractWorkspace =>
    private var _procedures: ProcedureInterface.ProceduresMap = ProcedureInterface.NoProcedures

    override def procedures: ProcedureInterface.ProceduresMap = _procedures

    def procedures_=(procs: ProcedureInterface.ProceduresMap): Unit = {
      _procedures = procs
    }

    override def setProcedures(procs: ProcedureInterface.ProceduresMap): Unit = {
      _procedures = procs
    }
