...
class DummyWorkspace extends Workspace {
  ...
  val world = new World
  override def procedures: ListMap[String,ProcedureInterface] = ListMap.empty[String, ProcedureInterface]
  ...
  override def runCompiledCommands(owner: JobOwner, procedure: ProcedureInterface) = unsupported
  override def runCompiledReporter(owner: JobOwner, procedure: ProcedureInterface) = unsupported
  ...
  override def procedures_=(procedures: org.nlogo.nvm.ProcedureInterface.ProceduresMap): Unit = unsupported
