...
case class AnonymousCommand(procedure: LiftedLambdaInterface, formals: Array[Let], binding: Binding, locals: Array[AnyRef])
extends AnonymousProcedure with org.nlogo.api.AnonymousCommand {
  ...
  def this(procedure: LiftedLambdaInterface, formals: Array[Let], allLets: List[LetBinding], locals: Array[AnyRef]) = {
